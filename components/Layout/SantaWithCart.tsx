...
export default function SantaWithCart() {
  ...
  return (
    <div className="fixed bottom-4 left-0 right-0 z-30 pointer-events-none overflow-visible h-36">
      ...
      >
        <div className="relative flex items-end gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              {/* Hat */}
              <path
                d="M 35 45 Q 60 15 85 45 L 80 50 Q 60 25 40 50 Z"
                fill="#DC2626"
              />
              ...
              {/* Beard */}
              <path
                d="M 40 58 Q 35 75 40 80 L 80 80 Q 85 75 80 58 Q 75 70 60 72 Q 45 70 40 58 Z"
                fill="#F3F4F6"
              />
          ...
          <div className="relative">
            ...
            >
              ...
              >
                ...
                <path
                  d="M 129 50 Q 125 42 129 37 Q 133 42 129 50"
                  fill="#F97316"
                />
              </motion.g>
              ...
              >
                ...
                <path
                  d="M 120 82 Q 117 75 120 71 Q 123 75 120 82"
                  fill="#DC2626"
                />
              </motion.g>
            </svg>
        ...
        {/* Speech Bubble - "Hi!" */}
        <motion.div
          className="absolute -top-8 left-20 bg-white rounded-2xl px-4 py-2 shadow-lg z-50"
